...
public enum ErrorCode {
    ...
    INVALID_EMAIL_PASSWORD(HttpStatus.BAD_REQUEST.value(), "Wrong email or password format"),
    ...
    //main
    PAGE_NOT_EXIST(HttpStatus.UNAUTHORIZED.value(), "page does not exist."),
    CATEGORY_NOT_EXIST(HttpStatus.UNAUTHORIZED.value(), "category does not exist."),
    TOKEN_NOT_EXIST(HttpStatus.UNAUTHORIZED.value(), "Token does not exist."),
    ;
